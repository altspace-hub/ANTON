...
const CATALOGUE = [
  ...
  {
    id: 'gymnasiet-economics',
    nameKey: 'subject.gymnasiet-economics',
    name: 'Ekonomi & Företag',
    persona: 'Nora',
    icon: <Briefcase className="h-5 w-5 text-adv-teal" />,
    tier: 'T3',
    modules: ['Företagsekonomi', 'Marknadsföring', 'Redovisning', 'Nationalekonomi'],
  },
  {
    id: 'gymnasiet-technology',
    nameKey: 'subject.gymnasiet-technology',
    name: 'Teknik & Innovation',
    persona: 'Leo',
    icon: <Monitor className="h-5 w-5 text-adv-teal" />,
    tier: 'T3',
    modules: ['Elektronik', 'Konstruktion', 'Teknikutveckling', 'Programmering'],
  },
  ...
  {
    id: 'uni-industriell-ekonomi',
    nameKey: 'subject.uni-industriell-ekonomi',
    name: 'Industrial Economics',
    persona: 'Prof. Lindström',
    icon: <Briefcase className="h-5 w-5 text-adv-teal" />,
    tier: 'T4',
    modules: ['Management', 'Operations Research', 'Corporate Finance', 'Strategy'],
  },
  {
    id: 'uni-datateknik',
    nameKey: 'subject.uni-datateknik',
    name: 'Computer Science & Eng.',
    persona: 'Leo',
    icon: <Code className="h-5 w-5 text-adv-teal" />,
    tier: 'T4',
    modules: ['Algorithms', 'Systems', 'Software Engineering', 'Research'],
  },
  {
    id: 'uni-kemiteknik',
    nameKey: 'subject.uni-kemiteknik',
    name: 'Chemical Engineering',
    persona: 'Viktor',
    icon: <FlaskConical className="h-5 w-5 text-adv-teal" />,
    tier: 'T4',
    modules: ['Thermodynamics', 'Reaction Eng.', 'Separation', 'Research'],
  },
  {
    id: 'uni-maskinteknik',
    nameKey: 'subject.uni-maskinteknik',
    name: 'Mechanical Engineering',
    persona: 'Prof. Lindström',
    icon: <Atom className="h-5 w-5 text-adv-teal" />,
    tier: 'T4',
    modules: ['Solid Mechanics', 'Fluid Mechanics', 'Thermodynamics', 'Manufacturing'],
  },
  {
    id: 'uni-elektroteknik',
    nameKey: 'subject.uni-elektroteknik',
    name: 'Electrical Engineering',
    persona: 'Prof. Lindström',
    icon: <Lightbulb className="h-5 w-5 text-adv-teal" />,
    tier: 'T4',
    modules: ['Circuits', 'Signal Processing', 'Power Systems', 'Control Theory'],
  },
];
