...
export default function DataInsightsPage() {
  ...
  const handleRun = async () => {
    ...
    try {
      ...
      const modelsToTry = ['claude-sonnet-4-5-20250929', 'claude-opus-5-5'] as const;
      let streamError = '';
      let usedModel = '';
    ...
    <div className="mx-auto max-w-4xl space-y-6 p-6">
      ...
      <div className="rounded-xl border border-border bg-adv-card p-5 shadow-lg">
        ...
        <p className="mt-3 text-xs text-adv-gray">
          Anton will analyze your data and generate interactive charts using Claude Opus 5.5.
        </p>
