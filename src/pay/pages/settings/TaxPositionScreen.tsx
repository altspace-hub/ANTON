/**
 * TaxPositionScreen — current-year tax position (#78, ported from Comm).
 *
 * Pulls residency + this-year's ledger (Pay's PaymentRecord + ReceivedRecord
 * via services/tax-bridge buildTaxInputs), calls computeTaxPosition() from
 * @futurechain/sdk, renders the AnnualSummary.
 *
 ...
 *   - RefusalResult (§8.3) → message + CSV-export-only path, no numbers
 */
 ...
 *  enabled? Italy is the canonical case today. */
