 ...
 *
 * Minimal v1 form: payee address (paste / type), label, amount in
 * FTC (fiat-first when oracle ships), recurrence picker. The picker
 * exposes the four simple recurrence kinds covered in
 * services/schedules.ts (daily / weekly / monthly / yearly) with
 * a small dropdown for the parameter.
 */
import { useState } from 'react';
import { useTranslation } from 'react-i18next';
import FiatAmountInput from '../../components/FiatAmountInput';
import {
  createSchedule, type Recurrence,
