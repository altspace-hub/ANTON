 ...
 * Pay flow with the payee + amount pre-filled and biometric required.
 * We never auto-sign and never pre-sign. EU regulator-safe — this
 * is not a SEPA standing order (which requires a PSP custodian) and
 * not a PSD3 VRP; it's a payment reminder with explicit per-cycle
 * consent. Same legal framing Apple Pay / Google Pay use.
 */
...
export default function ScheduledPaymentsScreen({ onBack, onAdd }: Props) {
