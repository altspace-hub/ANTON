 ...
 *
 * Bottom-of-page primary affordance: full width, comfortable tap
 * target, top margin auto so it pins to the end of a flex container.
 * Pass marginTopAuto={false} to drop that if used mid-page.
 */
