/**
 * languages.ts — the locale catalogue for the Comm App language picker.
 *
 ...
 *
 * Mirrors the 29-language set the main ANTON app ships under
 * public/locales/. en + sv ship complete Comm App translations today;
 * the rest fall back to en until their catalogue is filled in (the
 * i18n config's fallbackLng handles this transparently).
 */
...
/** Languages with a complete Comm App translation bundled today.
