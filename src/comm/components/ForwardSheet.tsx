    ...
    >
      ...
      >
        ...
        <div className="px-5 pb-2">
          <h2 className="text-base font-semibold text-[var(--color-text)]">Forward to</h2>
        </div>

        {!loaded ? (
          <p className="px-5 py-4 text-sm text-[var(--color-text-faint)]">Loading…</p>
        ) : candidates.length === 0 ? (
          <p className="px-5 py-4 text-sm text-[var(--color-text-faint)]">
            No other contacts with a known key. Add a contact and exchange QR codes first.
          </p>
        ) : (
