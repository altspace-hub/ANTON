  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 rounded-md border border-adv-blue/30 bg-adv-blue/10 px-3 py-1.5">
        <span className="text-xs font-medium text-adv-blue">Connection required: API</span>
      </div>
      ...
      <div>
        <label className="mb-1 block text-[11px] font-medium text-adv-gray">
          Endpoint Path
          <span className="ml-1 text-adv-gray font-normal">Supports {'{{variable}}'} references</span>
        </label>
        <input
          type="text"
      ...
      <div>
        <label className="mb-1 block text-[11px] font-medium text-adv-gray">
          ...
          <span className="ml-1 text-adv-gray font-normal">Reference as {'{{<name>.field}}'} in later steps</span>
        </label>
        <input
          type="text"
