  ...
  return (
    <div className="space-y-3">
      <div className="flex items-center gap-2 rounded-md border border-adv-blue/30 bg-adv-blue/10 px-3 py-1.5">
        <span className="text-[10px] font-medium text-adv-blue">Connection required: Database</span>
      </div>
      ...
      <div>
        <label className="mb-1 block text-[11px] font-medium text-adv-gray">
          SQL Query Template
          <span className="ml-1 text-adv-gray-med font-normal">Use {'{{variable}}'} for step data references</span>
        </label>
        <textarea
      ...
      <div>
        <label className="mb-1 block text-[11px] font-medium text-adv-gray">
          ...
          <span className="ml-1 text-adv-gray-med font-normal">Reference as {'{{<name>.rows[0].field}}'} in later steps</span>
        </label>
        <input
          type="text"
