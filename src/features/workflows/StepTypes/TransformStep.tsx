    ...
    <div className="space-y-3">
      ...
      <div>
        <div className="mb-2 flex items-center justify-between">
          ...
          <span className="text-[10px] text-adv-gray-med">{mappings.length} mapping{mappings.length !== 1 ? 's' : ''}</span>
        </div>

        {mappings.length > 0 && (
          <div className="mb-3 space-y-2">
            <div className="grid grid-cols-12 gap-1 px-1">
              <span className="col-span-4 text-[10px] text-adv-gray-med">Source path</span>
              <span className="col-span-3 text-[10px] text-adv-gray-med">Destination field</span>
              <span className="col-span-4 text-[10px] text-adv-gray-med">Transform expr (optional)</span>
            ...
            {mappings.map((mapping, idx) => (
              <div key={idx} className="grid grid-cols-12 gap-1 items-start">
                <input
                  ...
                  className="col-span-4 rounded border border-border bg-adv-dark-2 px-2 py-1 text-[11px] text-adv-off-white font-mono focus:border-adv-teal focus:outline-none"
                />
                <input
                  type="text"
                  ...
                  className="col-span-3 rounded border border-border bg-adv-dark-2 px-2 py-1 text-[11px] text-adv-off-white font-mono focus:border-adv-teal focus:outline-none"
                />
                <input
                  type="text"
                ...
                <button
                  ...
                  className="col-span-1 flex items-center justify-center pt-1 text-adv-gray-med hover:text-adv-red transition-colors"
                >
        ...
        <div className="rounded-lg border border-dashed border-border p-3">
          <p className="mb-2 text-[10px] text-adv-gray-med">Add new mapping:</p>
          <div className="grid grid-cols-12 gap-1 items-end">
            <div className="col-span-4">
              <label className="mb-1 block text-[10px] text-adv-gray-med">Source path</label>
              <input
                type="text"
                value={newMapping.sourcePath}
                onChange={(e) => setNewMapping((m) => ({ ...m, sourcePath: e.target.value }))}
                placeholder="{{step_1.field}}"
                className="w-full rounded border border-border bg-adv-dark px-2 py-1 text-[11px] text-adv-off-white font-mono focus:border-adv-teal focus:outline-none"
              />
            </div>
            <div className="col-span-3">
              <label className="mb-1 block text-[10px] text-adv-gray-med">Destination</label>
              <input
                type="text"
            ...
            <div className="col-span-4">
              <label className="mb-1 block text-[10px] text-adv-gray-med">Expression (optional)</label>
              <input
                type="text"
            ...
            <div className="col-span-1 flex justify-end">
              <button
                ...
                className="flex items-center gap-1 rounded bg-adv-teal px-2 py-1 text-[10px] font-medium text-adv-dark hover:bg-adv-teal-dark disabled:opacity-40 transition-colors"
              >
