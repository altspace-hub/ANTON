    ...
    <div className="space-y-3">
      <div>
        <label className="mb-1 block text-[11px] font-medium text-adv-gray">
          To
          <span className="ml-1 text-adv-gray font-normal">Supports {'{{variable}}'}, comma-separated for multiple</span>
        </label>
        <input
          type="text"
      ...
      <div>
        <label className="mb-1 block text-[11px] font-medium text-adv-gray">
          Body Template
          <span className="ml-1 text-adv-gray font-normal">Markdown supported. Supports {'{{variable}}'}</span>
        </label>
        <textarea
