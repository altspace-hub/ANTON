/**
 * Logo — ANTON Business brand mark.
 *
 * Three-chevron geometry from `logo_app/icon-launcher-master.svg`,
 * coloured with the Business signature blue (#3070C7) instead of
 * the Comm App's navy. White rounded-rect tile so it reads well
 * on the cream canvas + on the dark Android splash.
 */
interface LogoProps {
  ...
  className?: string;
  /** Override the chevron stroke colour. Default = blue accent. */
  color?: string;
...
export default function Logo({
  ...
  return (
    <svg
      ...
      role="img"
      aria-label="ANTON Business logo"
    >
