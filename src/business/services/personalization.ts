/**
 * personalization.ts — accent colour + light/dark mode for the
 * Business app.
 *
 * Mirrors the Comm App's personalization service so the ANTON suite
 * shares one mental model. Two runtime axes, both persisted to
 * localStorage:
 *   • accent — one of 8 swatches (blue = Business signature default).
...
const ACCENT_KEY = 'anton-business-accent';
const MODE_KEY = 'anton-business-mode';
