...
// FutureChain network mark (circle, blue primary) — brands the chain,
// not the app. Generated by scripts/make-fc-logos.cjs.
import fcLogoUrl from '../assets/fc_blue_circle_96.png';
