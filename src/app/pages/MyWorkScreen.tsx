          ...
          {SINCE_OPTIONS.map(o => {
            ...
            return (
              <button
                ...
                className="flex-shrink-0 rounded-full px-3 py-1.5 text-xs font-semibold transition active:scale-[0.97]"
                style={{
        ...
        {editing === 'title' ? (
          <>
            ...
            <input
              ...
              autoFocus
              placeholder="Title"
              className="w-full rounded-[var(--radius-r2)] px-3 text-sm font-semibold focus:outline-none"
              style={{
