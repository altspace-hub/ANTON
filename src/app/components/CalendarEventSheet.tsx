  ...
  return (
    ...
    >
      <div className="flex flex-col gap-3.5">
        ...
        <div>
          <label htmlFor="evt-title" className="mb-1 block text-[12px] font-semibold text-[var(--color-text-body)]">
            Title
          </label>
          <input
            id="evt-title"
            ...
            autoFocus
            className="w-full rounded-[var(--radius-r2)] px-3 text-[15px] focus:outline-none"
            style={{ ...inputStyle, height: 44 }}
          />
        </div>

        <div>
          <label htmlFor="evt-date" className="mb-1 block text-[12px] font-semibold text-[var(--color-text-body)]">
            Date
          </label>
          <input
            id="evt-date"
        ...
        <label className="flex items-center gap-2.5">
          <input
            ...
            className="h-4 w-4"
          />
          <span className="text-[14px] text-[var(--color-text)]">All-day event</span>
        </label>

        {!allDay && (
          <div className="flex gap-2.5">
            <div className="flex-1">
              <label htmlFor="evt-start" className="mb-1 block text-[12px] font-semibold text-[var(--color-text-body)]">
                Start
              </label>
              <input
                id="evt-start"
            ...
            <div className="flex-1">
              <label htmlFor="evt-end" className="mb-1 block text-[12px] font-semibold text-[var(--color-text-body)]">
                End
              </label>
              <input
                id="evt-end"
        ...
        <div>
          <label htmlFor="evt-loc" className="mb-1 block text-[12px] font-semibold text-[var(--color-text-body)]">
