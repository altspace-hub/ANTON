...
// The user-facing version. Kept equal to android-pay's `versionName` on
...
// `__APP_VERSION__` and documented it as coming from here — it never existed,
// so every enrollment silently reported "0.0.0".
