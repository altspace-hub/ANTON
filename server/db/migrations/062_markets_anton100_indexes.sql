-- Migration 062: Markets Pillar — ANTON 100 Indexes with Real Ticker Universes
...
INSERT OR IGNORE INTO market_indexes (id, name, description, index_type, philosophy, universe, max_holdings, rebalance_frequency, weighting_method, benchmark_symbol, status, budget, currency)
VALUES (
  'midx_seed_sweden100',
  'ANTON Sweden 100',
