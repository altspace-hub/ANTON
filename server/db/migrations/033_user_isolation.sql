...
ALTER TABLE registered_folders ADD COLUMN IF NOT EXISTS user_id TEXT NOT NULL DEFAULT 'default';
ALTER TABLE registered_folders ADD COLUMN IF NOT EXISTS org_id  TEXT NOT NULL DEFAULT 'default';

-- module_configs: allows per-user custom module configurations
ALTER TABLE module_configs ADD COLUMN IF NOT EXISTS user_id TEXT NOT NULL DEFAULT 'default';
ALTER TABLE module_configs ADD COLUMN IF NOT EXISTS org_id  TEXT NOT NULL DEFAULT 'default';

-- projects: project scope per user/org
ALTER TABLE projects ADD COLUMN IF NOT EXISTS user_id TEXT NOT NULL DEFAULT 'default';
ALTER TABLE projects ADD COLUMN IF NOT EXISTS org_id  TEXT NOT NULL DEFAULT 'default';

-- skills: per-user custom skills library
ALTER TABLE skills ADD COLUMN IF NOT EXISTS user_id TEXT NOT NULL DEFAULT 'default';
ALTER TABLE skills ADD COLUMN IF NOT EXISTS org_id  TEXT NOT NULL DEFAULT 'default';

-- reviews: per-user review history
ALTER TABLE reviews ADD COLUMN IF NOT EXISTS user_id TEXT NOT NULL DEFAULT 'default';
ALTER TABLE reviews ADD COLUMN IF NOT EXISTS org_id  TEXT NOT NULL DEFAULT 'default';
...
ALTER TABLE messages ADD COLUMN IF NOT EXISTS org_id TEXT NOT NULL DEFAULT 'default';
