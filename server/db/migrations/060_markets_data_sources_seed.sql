-- Migration 060: Markets Pillar — Seed Data Sources for FMP, EODHD, RSS
-- All sources seeded as disabled (is_active=0). Users enable after setting API keys.
-- Uses INSERT OR IGNORE for idempotency.

-- ── FMP (Financial Modeling Prep) ─────────────────────────────────────────────

INSERT OR IGNORE INTO market_data_sources (id, name, source_type, provider, config, fetch_interval_hours, is_active)
VALUES (
  'mds_fmp_prices',
  'FMP Global Prices',
  'api',
