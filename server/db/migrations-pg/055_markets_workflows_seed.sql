-- Migration 055 (PG): Markets Pillar — Workflow Definitions & Seed Indexes
-- PostgreSQL version: uses ON CONFLICT DO NOTHING instead of INSERT OR IGNORE.

-- ── Workflow Definitions ───────────────────────────────────────────────────────

INSERT INTO workflow_definitions (id, name, description, trigger_type, steps, config, status)
VALUES (
...
INSERT INTO market_indexes (id, name, description, index_type, philosophy, universe, max_holdings, rebalance_frequency, weighting_method, benchmark_symbol, status)
VALUES (
  'midx_seed_us100',
  'ANTON US 100',
