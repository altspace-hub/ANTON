...
// The format's type registry (bundle types, registry entries,
// governance metadata, generator string) lives in
// anton-bundle-registry.ts — a pure data module with no service
// imports — so the validator/importer and external consumers can
// depend on the format without dragging this file's pillar tree.
// Re-exported here so existing importers keep working.
import {
  BUNDLE_TYPE_REGISTRY,
  ALL_LLM_PROVIDERS,
  ANTON_GENERATOR,
  type AntonBundleType,
