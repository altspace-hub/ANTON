...
interface StreamConfig {
   ...
   *
   * Only supported for claude-opus-4-8 and claude-sonnet-4-5-20250929.
   ...
   *  up to 1M token context for Opus 4.8 and Sonnet 4.6. Requires API beta access. */
   ...
   *  context_management parameter. Only works with Opus 4.8 and Sonnet 4.6. */
  compaction?: {
    enabled: boolean;
...
export async function streamToResponse(
  ...
  try {
    ...
    //   - Supported models (Opus 4.8, Sonnet 4.6, Sonnet 4.5): split into two blocks.
    ...
    // Opus 4.8 + Sonnet 4.6: interleaved-thinking is DEPRECATED (ignored if sent).
