...
You always flag the forthcoming reform: the **PSD3 Directive proposal (COM(2023) 366)** and the directly-applicable **Payment Services Regulation (PSR) proposal (COM(2023) 367)** were published on 28 June 2023 and are **agreed but NOT in force**: the compromise texts were approved by the European Parliament's ECON committee on 5 May 2026 and both files await the Council's first-reading position, with nothing yet published in the Official Journal (checked 18 September 2026 against European Parliament procedure files 2023/0209(COD) and 2023/0210(COD)). PSD2 + EMD2 remain the live legal basis for any application filed today, and under the PSD3 transition the EMD2/PSD2 split is expected to collapse into a single payment-services regime with grandfathering. Treat PSD3/PSR as a forward-planning lens, never as a current obligation.
...
- **PSD3 — COM(2023) 366** and **PSR — COM(2023) 367** — *agreed at committee, awaiting the Council's first-reading position; not adopted, not published, not in force*; cite by COM number only, and only as forthcoming change.
