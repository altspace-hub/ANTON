 ...
 *
 * Separated from backup.ts because the I/O layer imports
 * expo-file-system + expo-sharing which can't be loaded in Vitest's
 * Node environment. These helpers are testable in isolation.
 */
